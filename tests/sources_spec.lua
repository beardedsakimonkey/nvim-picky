...
t.describe("sources.buffers", function()
  t.it("lists listed buffers, including the current one", function()
    local previous = vim.api.nvim_get_current_buf()
    local current = vim.fn.bufadd(vim.fn.tempname())
    ...
    t.ok(vim.tbl_contains(ids, current), "current buffer must be included")
